...
<div class="menu-navegacion">
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link active elemento-navegacion-plh" aria-current="page" href="{{ url('/administrador.home') }}">
                  Home
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link elemento-navegacion-plh" href="{{ url('/administrador.habilitar') }}">
                  Habilitar convocatoria
                </a>
            </li>
            <li class="nav-item">
              <a class="nav-link elemento-navegacion-plh" href="{{ url('/administrador.lista') }}">
