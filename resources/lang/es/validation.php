...
return [
    /*
    |--------------------------------------------------------------------------
    | Líneas de validación de idioma
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'password' => [
        ...
        'regex' => 'La contraseña debe incluir al menos una letra mayúscula, una letra minúscula, un número y un carácter especial.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se utilizan para intercambiar nuestro marcador de posición de atributo
    | con algo más amigable para el lector, como "Dirección de correo electrónico"
    | en lugar de "email". Esto simplemente nos ayuda a hacer que los mensajes sean un poco más claros.
    |
    */
